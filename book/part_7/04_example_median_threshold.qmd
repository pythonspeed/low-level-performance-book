# Let's optimize! 15× faster median local thresholding on an image
...
This article is an extract from a book I'm working on; test readers are currently going through initial drafts.
Aimed at Python developers, data scientists, and scientists, the book covers topics like instruction-level parallelism, memory caches, and other performance optimization techniques.
