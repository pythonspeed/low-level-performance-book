...
We can build a custom histogram algorithm based on two assumptions:
...
def histogram_median(bus_headways):
    ...
    # seconds, which is higher than the 99.9th percentile value.
    ...
    # Now that we know how many samples for every quarter minutes index,
    # add up the cumulative counts until we hit 50% of values:
