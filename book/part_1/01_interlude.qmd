...
* Your performance bottleneck involves computation, i.e. CPU or RAM, not disk or network access.
  See the appendix for some discussion of other bottlenecks.
...
Since we're focusing on the performance of code running on a single CPU core, we need to understand how that CPU works.
...
As you read through the book you will build a sophisticated, performance-oriented mental model of how the CPU works.
...
We can reduce CPU instructions in two ways:
