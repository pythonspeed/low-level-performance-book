...
[^cpucache]: In later chapters we'll see that keeping frequently accessed memory small can speed up your code, thanks to CPU memory caches. If the lookup table is too big, the cost of memory accesses might undo the benefits of reduced calculations.
