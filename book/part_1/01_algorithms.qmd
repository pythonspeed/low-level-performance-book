...
In the rest of the book I'm going to assume you've already identified which parts of the code are slow, broadly speaking, and that you've determined the performance bottleneck is computation.
