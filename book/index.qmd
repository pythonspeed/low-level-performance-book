...
You can no longer just ask _what_ an abstraction you're using does; you also need to ask _how_ it does it.
You need to ask how your code works, how your programming language works, how your libraries work, even how the computer hardware works.

You don't need to understand every detail of how they work, however: a simplified model will do.
I'll call this mental model of how an abstraction works a _mechanism_.
...
### From abstraction to mechanism: Three paths to speed up your code
...
2. **The compiler:** Once you switch to a compiled language, you need to know at least a little about what the compiler speeds up your code—and just as importantly, what it can't do.
