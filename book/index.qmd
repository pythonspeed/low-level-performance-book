...
Writing fast code is different from the normal way we write code.
Usually we focus on _correctness_: does our calculation give the right result?
...
1 + 1 ought to equal 2, no matter if we're:
...
We can no longer just ask what our abstractions do, and instead we also need to understand _how_ they work.
How our code works, how our programming language works, how our libraries work, even how the computer hardware works.

If you can understand the actuality of how the abstractions are implemented, you can write code that will allow you to process more data, run more experiments, and get results faster.
You will be able to unleash the astounding computational speed that computers give us.
...
Assuming computation is your bottleneck, getting faster results typically involves either creating or using existing Python extensions written in a fast, low-level, compiled language: C, C++, Fortran, Cython, Numba, Rust, and others.
...
This is not, however, primarily a book about writing Python extensions.
Rather, the goal is to ensure that when you write computational code—for a Python extension, but also standalone—you will be able to write significantly faster code.
...
### From abstraction to actuality: three ways to speed up your code

To speed up computational code, there are three sets of abstractions whose actuality you will need to understand:
...
2. **The compiler:** Once you switch to a compiled language, you will need to know at least a little about what the compiler will do to speed up your code—and just as importantly, what it can't do.
...
In this chapter, as motivation to what you can achieve, we'll briefly go over each actuality (the calculations in your code, the compiler, and the CPU) in turn, previewing some of the different ways they can speed up or slow down your code.
...
## Actuality #1: How your code works
...
## Actuality #2: How compilers work
...
In particular, to maximize the performance of computation, you should write code that is optimized by:
