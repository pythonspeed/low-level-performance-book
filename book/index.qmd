...
This book limits itself to one particular subset of the performance problem: computation, the work your CPU does to calculate results.
But to make sure this is relevant to your particular situation, I provide a quick review of the bigger picture of performance in the first chapter of the book, together with references to additional resources.
