...
If this guess turns out to be wrong, the CPU will automatically undo the incorrect work it did.
The result will be correct, but the resulting code will run slower.

This means that branches where the CPU can't predict the result can make your program run much more slowly.
