...
We can no longer just ask _what_ our abstractions do, we also need to ask _how_ they do it.
How our code works, how our programming language works, how our libraries work, even how the computer hardware works.
I'll call this hidden side of an abstraction its _actuality_: how it actually works.

If you can understand the actualities of the abstractions you rely on, you can write code that will allow you to process more data, run more experiments, and get results faster.
In short, you will be able to unleash the astounding computational speed that computers give us.
...
This is not a book about writing Python extensions.
Rather, the goal is to help you write faster computational code—both for Python extensions, and for standalone programs.
