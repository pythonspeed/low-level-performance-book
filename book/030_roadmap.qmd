...
To know whether your code is faster or not, you need some way to measure its speed.
That means:

1. Choosing an appropriate metric (see chapter XXX).
2. Implementing a benchmarking setup that minimizes noise and distortion (see chapter XXX).
...
If your function is now fast enough, you're done!

### Step 3. Think about the Practice of Parallelism
...
### Step 4. Apply parallelism, if you haven't already
