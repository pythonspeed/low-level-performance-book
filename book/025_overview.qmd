...
So if computers are so fast, why isn't our software faster by default?
...
So my goal with this book isn't just to help you speed up software that you know is unacceptably slow.
My goal is also to help you write software that is fast from the start.

## Five practices to speed up your Python software

If you're going to write faster software, you need to understand the different bottlenecks that keep your code slow, and the different ways you can speed it up.
