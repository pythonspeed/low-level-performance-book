...
Each one of these practices can make your code faster _in a different way_ because it relies on different approaches to speed.
So while you can just start with one, you can often apply multiple practices to go even faster.
If you're lucky, you can use all five!!!!!
