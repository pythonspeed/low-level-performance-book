...
But also due to the limited size of CPUs' memory caches, using more memory can also result in code running more slowly; we'll cover these caches in a later chapter.
