...
**Dataframes:** Dataframes have named columns which can e different types, similar to a spreadsheet.
...
There are Arrow implementations for C++, Rust, and other languages, and it can also be used from Cython, but all of them can interoperate because they use the same in-memory representation.
