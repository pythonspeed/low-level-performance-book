...
If we can rely on the compiler to inline the functions, we can choose to break up our code across multiple functions without having to worry about performance implications.
