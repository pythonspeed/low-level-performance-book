...
[^therac-25]: A real world example resulted in several deaths from radiation poisioning: https://en.wikipedia.org/wiki/Therac-25
...
* For Numba it's not clear to me how you can do this, since Numba doesn't have asserts you can disable.

The checks for overlow happen at runtime, so they will only catch bugs triggered by code you run.
