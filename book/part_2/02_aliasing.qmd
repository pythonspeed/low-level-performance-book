...
* A pointer is a piece of data that points at another memory address.
  For example, in Numba every NumPy array or view has a pointer that points at the location in memory of the underlying data.
