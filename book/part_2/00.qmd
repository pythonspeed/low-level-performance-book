...
Cython is another compiled language you can use, with an extra stage of initial compilation: first is compiled into C or C++, and then the C/C++ code is compiled to machine code.

Over the next few chapters, we'll see how compilation, coupled with knowledge of data types, generates code that can run quickly.
