...
Once you switch to compiled code, you encounter a new set of issues that are specific to these kinds of languages.
The first is memory management, which we'll discuss in the next chapter, focusing specifically on the performance implications.
