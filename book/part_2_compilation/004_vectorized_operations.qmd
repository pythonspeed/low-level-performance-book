...
To see why this might be necessary, and when you should choose to do so, I'll start with an example, after a brief but necessary educational interlude.
...
For more details on this and other technologies used, [see the appendix](../appendices/010_prerequisites.qmd).
...
Switching from Python to compiled code can be more or less faster depending how much it continues to interact with Python.
In the next chapter, I'll demonstrate the speedups you can get from leaving more and more Python behind.
