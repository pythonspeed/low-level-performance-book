...
Using these two constraints, I implemented an approximate median algorithm, by using a histogram:
...
Another way to speed up this calculation is to run the same algorithm, but on a random sample of the words novel, say 5,000 words chosen without replacement.
