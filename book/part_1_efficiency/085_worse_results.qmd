...
Instead of exact counts, I will switch to a version that returns the relative percentages of our three categories:
...
This makes it easier to answer our question about relative use of gender:

```{python}
gendered_words(WORDS)
```

This change will allow me to optimize the function further in the next section.
