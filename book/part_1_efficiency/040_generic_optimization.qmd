...
Given large amounts of data, the bulk of your processing will happen inside the loop, the so-called "hot" part of your code[^hot].
...
[^hot]: Your CPU will actually get hotter when you're spinning in a loop doing computation!
...
All the techniques in this chapter involve doing less work for a specific calculation.
Another way you can get rid of repetitive work is by reusing calculation results, which I'll discuss in the next chapter.
