...
We saw related performance differences in the previous chapter as well.
Specifically, when you're iterating over an N-dimensional array in a way that matches memory layout, Numba is able to generate a version of the code that relies on the fact the data is contiguous.

Your particular programming language will have its own ways of dealing with this difference.
