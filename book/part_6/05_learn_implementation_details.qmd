...
The implmentation mechanism is calling ["striding"](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.strides.html).
...
The compiler can do a lot more optimization if it knows that data is laid out in a contiguous manner.
