...
**Once inputs are large enough, the smarter algorithm in Python is faster than the compiled Numba version.**
That's why it's so important to pick a good algorithm: a slow algorithm will overwhelm any benefits you get from switching to a faster programming language.
