...
In the previous chapter you saw how linearly traversing memory is faster.
...
In this chapter I'll look at a particular example, NumPy views, but similar issues can potentially apply to any data structure you are using.
...
If I mutate the underlying array, this change is reflected in both views:
...
The array I'm looking at is two dimensional, but memory is best thought of as one dimensional.
...
The versions that can assume the array is contiguous are much faster when the caller passes in a contiguous array, because the compiler can optimize better:
...
Now that you have some understanding of the Practice of Mechanical Sympathy, you can move on to [The Practice of Parallelism](../part_4/000_what_is.qmd), which allows you to take advantage of multiple CPU cores.
