...
Running `random_sample()` on the `int8` array will be faster, at least in part because the data fits better into the L3 cache:
...
Having learned about memory caches, the next chapter will discuss the shape of data in memory, and how that can impact performance.
