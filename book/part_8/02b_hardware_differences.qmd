...
A program that runs on x86-64 _cannot_ run on ARM, and vice versa, without some sort of software emulation layer.
...
The few exceptions where the code didn't get faster on the M1 are mentioned in the relevant chapters of the book.
