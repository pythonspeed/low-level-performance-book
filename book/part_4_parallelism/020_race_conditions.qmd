...
Even if you're not using threads, you can still cause race conditions.
Any time you are concurrently writing to a shared location you can have these sorts of problems.
For example:
...
Because these problems are universal, be careful any time you are writing to shared locations.
