...
To avoid data races in its internal implementation, Python has traditionally used a global interpreter lock.
This can reduce parallelism in Python applications, as I discuss in the next chapter.
