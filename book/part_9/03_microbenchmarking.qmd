# Use microbenchmarks to measure your code's performance

In much of this book we've relied on microbenchmarks to measure whether or not code is getting faster: we run the code a large number of times, and report how long it took to run on average.
