# Get rid of branches with branchless programmin

## Why branches can slow down your code
...
## An example of branch misprediction

Let's see an example of how an unpredictable branch can slow down your code.
