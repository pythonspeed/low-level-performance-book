...
def sum2(arr):
    ...
    for i in range(len(arr)):
        total1 += arr[i]
        # 😎 Swap the accumulators so the next iteration adds to the next one:
        total4, total1, total2, total3 = total1, total2, total3, total4
...
On a Mac M1 CPU this technique didn't speed things up.
:::
