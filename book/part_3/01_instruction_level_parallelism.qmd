...
As an equivalent to our `sum1()/sum2()` example above, here's a normal sum function:
...
And here how you would generates code that is the equivalent of the 4 accumulators we used in the `sum2()` example above:
...
This is both more readable and less error-prone than the rest of the sped-up examples in this chapter.
