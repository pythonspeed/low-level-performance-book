...
def generate_random_numbers_3(n):
    ...
    for i in range(n // 4):
        ...
        result[i * 4    ] = random_number1 >> 32
        result[i * 4 + 1] = random_number2 >> 32
        result[i * 4 + 2] = random_number3 >> 32
        result[i * 4 + 3] = random_number4 >> 32

    # Calculate the remaining last few values:
    for i in range(n % 4):
        random_number1 = lcg(random_number1)
        result[-i] = random_number1 >> 32
