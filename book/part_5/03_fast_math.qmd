...
In this case, the compiler can't improve on the manual optimizations we've already done, so fast math mode adds no performance:
...
In this case the fast math mode doesn't speed things up:
